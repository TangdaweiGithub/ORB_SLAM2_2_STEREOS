...
{
public:
    FrameDrawer(Map* pMap, const int sensor);
...
protected:
    ...
    cv::Mat mImBack;
    int NBack;
    vector<cv::KeyPoint>mvCurrentKeysBack;
    vector<bool> mvbUselessPointBack, mvbDiscardedPointBack;
    int mnUselessPointBack, mnDiscardedPointBack;
    vector<cv::KeyPoint> mvIniKeysBack;
    vector<int> mvIniMatchesBack;
    vector<cv::KeyPoint> mvBadDescriptorBack;
    vector<float> mvBadDescriptorRadiusBack;
    vector<cv::KeyPoint> mvGoodDescriptorBack; //For debug use.
    vector<float> mvGoodDescriptorRadiusBack;  //For debug use.
