...
public:
    ...
    MapPoint* LoadMapPoint( ifstream &f, ofstream &outfile, ofstream &outfile_ue4);
    KeyFrame* LoadKeyFrame( ifstream &f, std::vector<MapPoint*> &vmp, SystemSetting* mySystemSetting, ofstream &outfile, ofstream &outfile_ue4);
