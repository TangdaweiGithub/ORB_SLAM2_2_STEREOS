...
void Map::Load ( const string &filename, SystemSetting* mySystemSetting, KeyFrameDatabase* mpKeyFrameDatabase )
{
    ...
    for( unsigned int i = 0; i < nKeyFrames; i ++ )
    {
        ...
        kf = LoadKeyFrame(f, mySystemSetting, outfile_keyframe, outfile_keyframe_ue4);
        AddKeyFrame(kf);
...
KeyFrame* Map::LoadKeyFrame(ifstream &f, SystemSetting* mySystemSetting, ofstream &outfile, ofstream &outfile_ue4)
{
